...
計画通り進んでいるか，進捗を確認するためのマイルストーンをつくりましょう。最初は大雑把な計画でもよいですが，慣れてきたら粒度を細かくしましょう。

計画を立てても，必ずそのとおりに進行するわけではありません。スランプの時期には思い切って休むことも必要です。計画通り行かなかったからと言ってすべてを投げ出さないでください，計画を修正して継続しましょう。

学習記録を残しましょう。例えば勉強した時間をグラフに塗りつぶしていく
だけでも効果があります。カレンダーなどにシール(使い分けるとよい)を貼ってゆくのもよいでしょう(ゲーミッフィング理論)。

- 1年次
    - 中学までの復習(英語，数学等の積み上げ系)
    - 基礎学力(語彙力，速読)
    - 学校の勉強(復習中心)
- 2年次
    - 基礎学力(語彙力，速読)
...
運動において基礎体力が必要なように，学力においても基礎学力というのはとても大切なファクターです。基礎体力がすぐにつかないように基礎学力も養成するのに時間がかかるものですが，学力においてとても重要なパラメータです。
この力を習得するとその後の伸びが全然違いますので，先ずはこの力をつけましょう。

##### 記憶のメカニズム

記憶には，即時記憶，近時記憶，長期記憶があります。
例えば，電話番号などの数字を数秒間覚えるようなきわめて短時間の記憶を即時記憶といいます。通常ではこのような電話番号はすぐに忘れてしまいますが，これが大切な相手の番号となると覚えておこうとします。その場合，脳は情報信号の処理と符号化を行います，これが近時記憶です。
...
従来の記憶方法は，記憶強化(反復)が有効と考えられていましたが近年の研究によると単なる繰り返し(維持リハーサルとよばれる)は，長期記憶にそれほど有効ではないと結論付けられています。代わって情報に対するイメージの構成や意味的処理によって既有知識と関連づける **精緻化リハーサル**が有効であることがわかって来ました。
...
学習計画を，カレンダーなどで管理することが，重要になります。スマートフォンをもっているなら Ankiなどのソフトをつかってもよいです。
新規学習6割，復習4割の割合でおこなうこと良いでしょう。
...
これらを上手く勉強に活かした例として，現役で東京大学に合格し在学中に，司法試験，国家公務員第I種を一発合格。オール「優」の成績で「東大総長賞」を受賞した弁護士、山口真由さんの勉強方法があります。

[教科書を7回読むだけで、断然トップになれた!](mayu.md)

 - 教科書を繰り返し読む。3回くらいまでは土台作り， **全体像をつかむ**
 - それ以降で記憶の確認作業。 4-5回目くらいで **理解度が一気に上がる**
 - この方法を使うためには， **速読力と語彙力**が必要となる。
...
読書速度と語彙力は，地道に身につけていきましょう。基本は読書になります。語彙力を増やすためにも名著や漢文系の本がよいでしょう。速読のテクニックとしては，心で声をださないで，ブロックで捉える。周辺視野を鍛えて，行頭，行末をみないなどがあります。

また人間の脳は補正がかかるのでこんな文もちゃんと読めます。
...
- 頭のいい人は，切り替えがうまい，スイッチの入れ方をおぼえよう
- 脳を活性化するために，息をしばらく止めてみよう
- 睡眠不足は，集中力をおとす原因! ちゃんと休息を
- 夜の勉強より，朝の勉強。朝，勉強するくせをつけよう

#### ノートのとり方

- ノートは，学習の理解の補助。ノートを取らない人もいる。
- コーネルメソッドやマインドマップが効率的
